 ...
 * d) for every nested region we can define a new number of threads, which will execute the given task. this leads to a parallel region within another parallel region. 
 */
